...
import {generateHeightfieldFromMesh} from './terrainHelper.js';
...
const VIEWERMAIN = null;

const debugRend = null;
...
export class Viewer {
  ...
  constructor (el, options, pointD) {
    ...
    this.gWorld = new CANNON.World();

    this.gWorld.broadphase = new CANNON.SAPBroadphase(this.gWorld);

    //this.cannonDebugRenderer = new CannonDebugRenderer( this.scene, this.gWorld );
    //this.debugRend = new CannonDebugRenderer( this.scene, this.gWorld );


    //this.gCannonDebugRenderer = new THREE.CannonDebugRenderer(this.scene, this.gWorld);
  ...
  load ( url, rootPath, assetMap ) {
    ...
    return new Promise((resolve, reject) => {
      ...
      loader.load(url, (gltf) => {
        ...
        this.setHeight(scene, clips, this.pointDistance);
  ...
  async setHeight(scene, clips, pd) {
 
    const heightField = await generateHeightfieldFromMesh(scene, Number(pd));
 
    this.gWorld.addBody(heightField); 
    this.setContent(scene, clips);
